...
FlutterFire will manage the reCAPTCHA widget out of the box by default, however provides control over how it is displayed and configured if required.
...
<Image src="recaptcha-widget.jpg" alt="reCAPTCHA Widget Example" />
...
<Image
  src="recaptcha-widget-inline.jpg"
  alt="Inline reCAPTCHA Widget Example"
/>
