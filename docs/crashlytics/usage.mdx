...
![Crashytlics - Enable in the console](enable-firebase-crashlytics.png)

Until an error has been reported, you will see this screen.

![Crashytlics init screen](crashlytics-init.png)
...
This will crash the currently running application. You will then need to manually re-open your application on your emulator for Crashlytics to submit the crash report to the Firebase Console.

Restarting the application will then update the Firebase console:

![Crashytlics ready](crashlytics-ready.png)
